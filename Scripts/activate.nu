...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\zerim\Documents\dev\applicant_registration_back'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\zerim\Documents\dev\applicant_registration_back\Scripts\deactivate.nu'
