import { BadRequestException, Body, Controller, FileTypeValidator, Get, MaxFileSizeValidator, Param, ParseFilePipe, Post, Put, Query, Req, Res, UploadedFile, UseGuards, UseInterceptors } from '@nestjs/common';
import { FileInterceptor } from '@nestjs/platform-express';
import { AuthenticatedGuard } from 'src/auth/guards/authenticated.guard';
import { FileType } from 'src/models/user_documents';
import { RequestType } from 'src/types';
import { ParamDocumentUpdateDTO, UpdateDocumentDTO } from 'src/users/dto/updateData.dto';
